...
var email_pattern = /^[a-z]{3,8}@(gmail|yahoo|admin)\.com$/
...
if(email.value=='admin@admin.com' && password.value== 12345){
   
    window.location.href=`http://127.0.0.1:5501/ahmed/index.html` 
 }
 else if
     (!error){
             var userSignUp ={
              ...
              window.location.href=`http://127.0.0.1:5501/crud.html`
 }
